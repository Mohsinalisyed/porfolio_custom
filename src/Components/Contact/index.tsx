...
const Contact= () => {
  ...
  const handleSubmit = (e:any) => {
    e.preventDefault();
    setLoading(true);
    emailjs.send('service_9om7xnr', 'template_j4oxnpx', values, '0sGY_6AthzL0ACvBx')
      .then(response => {
  ...
  <div className="main-contact">
    ...
    <div className="contact-feild">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <InputFeild value={values.fullName} handleChange={handleChange} label="Full Name" name="fullName" type="text" placeholder="John Doe" />
        <InputFeild value={values.email} handleChange={handleChange} label="E-Mail" name="email" type="email" placeholder="jphn@example.com" />
        <InputFeild value={values.phone} handleChange={handleChange} label="Phone" name="phone" type="number" placeholder="+923xx-XXXXXXXXXX" />
        <TextareaField value={values.message} handleChange={handleChange} label="Your message here" name="message" />
        <Button strTitle="Send"/>
      </form>
    </div>
