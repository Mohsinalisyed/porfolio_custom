...
const Header = () => {
  ...
  <a className="navbar-brand protfolio-text" href="#"><span>P</span>ort<span>F</span>olio</a>
  ...
  <div className="collapse navbar-collapse" id="navbarText">
    ...
    <span className=" ">
      ...
      <li className="nav-item d-flex">
        ...
        href="https://bitbucket.org/mohsin5775/portfolio/src/master/" 
       ...
       <Tooltip id="bitbucket" />
        ...
        ><FaGithub/></a>
          <Tooltip id="github" />
        <a className="nav-link" href="https://famous-conkies-d36fd3.netlify.app"
